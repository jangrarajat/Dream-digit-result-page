export default function RonySection() {
  return (
    <div className="bg-red-800 text-white text-center py-6 px-4 rounded-xl mx-2 mt-4 border-2 border-red-500">

      {/* TITLE */}
      <h2 className="font-bold text-lg">🙏 ONLINE KHAIWAL 🙏</h2>
      <h3 className="font-semibold mt-1">RONY BHAI</h3>
